	...
	testCases := []struct {
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.RoleAtPath("namespaces/foo/role.yaml",
					core.Namespace("foo"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/rules"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.FileObject(crdUnstructured(t, kinds.Anvil(),
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, "/spec/group, /spec/names/kind, /spec/names/plural, /spec/scope, /spec/versions, /status/acceptedNames/kind, /status/acceptedNames/plural, /status/conditions, /status/storedVersions"),
				...
				fake.AnvilAtPath("namespaces/foo/anvil.yaml",
					core.Namespace("foo"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/spec/group, /spec/names/kind, /spec/names/plural, /spec/scope, /status/acceptedNames/kind, /status/acceptedNames/plural, /status/conditions, /status/storedVersions"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleAtPath("cluster/prod-admin_cr.yaml",
					core.Name("prod-admin"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configmanagement.gke.io~1cluster-selector, /rules"),
				...
				fake.ClusterRoleAtPath("cluster/prod-owner_cr.yaml",
					core.Name("prod-owner"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configsync.gke.io~1cluster-name-selector, /rules"),
					core.Annotation(csmetadata.ClusterNameAnnotationKey, "prod"),
					core.Annotation(csmetadata.ClusterNameSelectorAnnotationKey, "prod"),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/cluster/prod-owner_cr.yaml")),
				fake.Namespace("namespaces/bookstore",
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configsync.gke.io~1cluster-name-selector"),
					core.Annotation(csmetadata.ClusterNameAnnotationKey, "prod"),
					core.Annotation(csmetadata.ClusterNameSelectorAnnotationKey, "prod"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("namespaces/bar/prod-ns",
					core.Label("env", "prod"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/labels/env"),
				...
				fake.RoleBindingAtPath("namespaces/bar/sre-rb.yaml",
					...
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configmanagement.gke.io~1namespace-selector, /roleRef/apiGroup, /roleRef/kind, /roleRef/name"),
					core.Annotation(csmetadata.NamespaceSelectorAnnotationKey, "sre-supported"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleBindingAtPath("cluster/foo/crb.yaml",
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/roleRef/apiGroup, /roleRef/kind, /roleRef/name"),
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				validRepoSync("bookstore", "repo-sync-1", "namespaces/bookstore/rs.yaml",
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, "/spec/git/auth, /spec/git/period, /spec/git/repo, /spec/sourceType, /status/rendering/lastUpdate, /status/source/lastUpdate, /status/sync/lastUpdate"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1beta1"),
				)},
		},
	}
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("prod-shipping",
					core.Label("sre-supported", "true"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/labels/sre-supported"),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/prod-shipping/namespace.yaml")),
				fake.Namespace("dev-shipping",
					core.Label("dev-supported", "true"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/labels/dev-supported"),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/dev-shipping/namespace.yaml")),
				fake.RoleAtPath("sre-role.yaml",
					core.Name("role"),
					core.Namespace("prod-shipping"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configmanagement.gke.io~1namespace-selector, /rules"),
					core.Annotation(csmetadata.NamespaceSelectorAnnotationKey, "sre"),
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.UnstructuredAtPath(
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, "/metadata/annotations/configmanagement.gke.io~1managed"),
					core.Annotation(csmetadata.ResourceManagementKey, csmetadata.ResourceManagementDisabled),
